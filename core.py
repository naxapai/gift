    ...
    def _tz_signal_math(self, v: dict) -> dict:
        ...
        if score >= 0.62 and undervalue >= 0.22 and expected_profit_pct >= 0.18 and forecast_max > -0.05:
            ...
            # Soft BUY for strong profitable setups in sparse datasets.
                ...
                or (confidence >= 0.45 and score >= 0.20 and undervalue >= -0.03 and forecast_max >= -0.42)
                or (confidence >= 0.43 and score >= 0.195 and undervalue >= -0.02 and forecast_max >= -0.42)
            ):
                action_hint = "WATCH"
            else:
                action_hint = "SKIP"
