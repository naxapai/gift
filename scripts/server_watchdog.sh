...
start_server() {
  env \
    ...
    FRAGMENT_MAX_COLLECTIONS=80 \
    FRAGMENT_MAX_PAGES_PER_COLLECTION=5 \
    FRAGMENT_MAX_CARDS_PER_COLLECTION=80 \
    FRAGMENT_FETCH_BUDGET_SEC=600 \
    FRAGMENT_TIMEOUT_SEC=12 \
    FRAGMENT_MIN_EVENTS=0 \
    FRAGMENT_MIN_COLLECTIONS=50 \
    FRAGMENT_MIN_BACKGROUNDS=0 \
