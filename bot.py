...
MIN_CONFIDENCE = int(os.getenv("BOT_MIN_CONFIDENCE", "48"))
DYNAMICS_PCT = float(os.getenv("BOT_DYNAMICS_PCT", "4"))
...
SCORE_DELTA_MIN = float(os.getenv("BOT_SCORE_DELTA_MIN", "4"))
CONF_DELTA_MIN = float(os.getenv("BOT_CONF_DELTA_MIN", "6.4"))
CHANGE24H_DELTA_MIN = float(os.getenv("BOT_CHANGE24H_DELTA_MIN", "6.4"))
