...
function renderOverview(overview) {
  ...
  const kpis = [
    ...
    ["Объем 24ч", `${formatTon((overview.key_metrics || {}).volume24h_ton)} TON`],
    ["Сред. ликвидность 24ч", Number((overview.key_metrics || {}).avg_liquidity24h || 0).toFixed(2)],
    ["Провайдер degraded", (Array.isArray(overview.provider_health) && overview.provider_health[0]?.degraded) ? "да" : "нет"],
